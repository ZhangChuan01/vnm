    ...
    <div>
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;selectAddrId=index;addressId=item.addressId">
                    <dl>
                      <dt>{{item.userName}}</dt>
                    ...
                    <div class="addr-opration addr-del">
                      <a href="javascript:;" class="addr-del-btn" @click="delAress(item.addressId)">
      ...
      <modal :mdShow="isMdShow" @close="closeModal">
        ...
        <div slot="btnGroup" style="text-align:center;">
          <a href="javascript:;" class="btn btn--mm" @click="confirm">确认</a>
          <a href="javascript:;" class="btn btn--mm" @click="isMdShow=false">取消</a>
        </div>
      </modal>
      <my-footer></my-footer>
    </div>
...
<script>
  ...
  export default{
      ...
      methods: {
        ...
        confirm(){
          axios.post("/users/delAdress",{addressId:addressId}).then((response) => {
